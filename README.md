...
- Ежедневная ревизия подписок: если пользователь больше не состоит в обязательном чате, его подписка удаляется из Remnawave
...
- ежедневная фоновая ревизия подписок пользователей.
...
5. Ежедневное удаление подписок пользователей, которые больше не состоят в обязательном Telegram-чате
...
- Ревизия подписок не удаляет подписку, если Telegram API временно не вернул статус участника
